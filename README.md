...
The key features:
1. [x] Simple single sign on with platforms such as FaceBook, Google, Linkedin, Twitter, and many more.
2. [x] Users have their own profile (bookstore) which allow them to advertise and sell their textbooks.
3. Adding/Updating Books.
   - [x] Having the auto-complete feature when adding/updating a new or existing book.
...
4. [x] Have a good chat/messaging system in place in order to facilitate communication between buyers and sellers.
5. [ ] <strike>A middle man payment system;  
