...
export default function Privacy() {
  return (
    <>
      <MetaDecorator
        description={metags.privacyPage.description}
        title={metags.privacyPage.title}
      />
        ...
        <MDBRow className="justify-content-center">
          <MDBCol md="8">
            ...
            <p>
              ...
              numbers; email addresses; usernames; passwords; contact
              preferences; contact or authentication data; and other similar
              information.
            </p>
            ...
            <p>
              ...
              use our Website and which we record in log files. Depending on how
              you interact with us, this log data may include your IP address,
            ...
            <p>
              ...
              LOGINS?&quot; for further information. To post testimonials. We
              ...
              at yichenzhu1337@gmail.com and be sure to include your name,
              testimonial location, and contact information. Request feedback.
              We may use your information to request feedback and to contact you
              about your use of our Website. To enable user-to-user
              communications. We may use your information in order to enable
              user-to-user communications with each user's consent. To manage
            ...
            <p>
              ...
              __________. For other business purposes. We may use your
            ...
            <p>
              ...
              for a specific purpose. Legitimate Interests: We may process your
              data when it is reasonably necessary to achieve our legitimate
              business interests. Performance of a Contract: Where we have
              entered into a contract with you, we may process your personal
              information to fulfill the terms of our contract. Legal
              ...
              business to another company. Google Maps Platform APIs. We may
              share your information with certain Google Maps Platform APIs
              (e.g., Google Maps API, Place API). To find out more about
              Google&rsquo;s Privacy Policy, please refer to this link. We use
              certain Google Maps Platform APIs to retrieve certain information
              ...
              Notice, which can be found at this link: __________. Vendors,
            ...
            <p>
              ...
              titled &quot;HOW CAN YOU CONTACT US ABOUT THIS NOTICE?&quot;. Ad
              Networks Affiliate Marketing Programs Cloud Computing Services
              Communication &amp; Collaboration Tools Data Analytics Services
              Data Storage Service Providers Finance &amp; Accounting Tools
              Government Entities Order Fulfillment Service Providers Payment
              Processors Performance Monitoring Tools Product Engineering &amp;
              Design Tools Retargeting Platforms Sales &amp; Marketing Tools
              Social Networks Testing Tools User Account Registration &amp;
            ...
            <p>
              ...
              and consent to such minor dependent&rsquo;s use of the Website. If
            ...
            <p>
              ...
              account settings and update your user account. Upon your request
              to terminate your account, we will deactivate or delete your
            ...
            <p>
              ...
              see our Cookie Notice: __________.
            </p>
            ...
            <p>
              ...
              marketing email list &mdash; however, we may still communicate
              ...
              To otherwise opt-out, you may: Access your account settings and
            ...
            <p>
              ...
              here. This privacy policy was created using Termly&rsquo;s Privacy
              Policy Generator.
            </p>
          </MDBCol>
        </MDBRow>
