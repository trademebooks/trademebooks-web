...
export default function TermsPage() {
  return (
    <>
      <MetaDecorator
        description={metags.termsPage.description}
        title={metags.termsPage.title}
      />
      <div className="header-container text-center">
        <h1 className="font-weight-bold">Terms of Use</h1>
      </div>
        ...
        <MDBRow className="justify-content-center">
          <MDBCol md="8">
            ...
            <p>
              ...
              and/or the Marketplace Offerings, you have read, understood, and
            ...
            <p>
              ...
              Site&rsquo;s content. We do not endorse or recommend any
              Marketplace Offerings and the Site is provided for informational
            ...
            <p style={{ marginLeft: 26 }}>
              <ol>
                ...
                <li>
                  ...
                  (&ldquo;gifs&rdquo;), 1x1 pixels, web bugs, cookies, or other
            ...
            <p>
              ...
              hosted in Canada. If you access the Site or the Marketplace
              Offerings from any other region of the world with laws or other
              requirements governing personal data collection, use, or
              disclosure that differ from applicable laws in Canada, then
              through your continued use of the Site, you are transferring your
              data to Canada, and you agree to have your data transferred to and
              processed in Canada.
            </p>
            ...
            <p>
              ...
              Canada. Chosen Solutions and yourself irrevocably consent that the
            ...
            <p>
              ...
              place, of arbitration shall be Markham, Canada. The language of
              the proceedings shall be English. The governing law of the
            ...
            <p>
              ...
              THE ACCURACY OR COMPLETENESS OF THE SITE&rsquo;S CONTENT OR THE
              ...
              MARKETPLACE OFFERINGS, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR
              THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY
            ...
            <p>
              ...
              TO $100.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO
            ...
            <p>
              These terms of use were created using Termly&rsquo;s Terms and
