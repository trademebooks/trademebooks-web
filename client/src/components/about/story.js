...
const Story = () => {
  return (
    <div>
      ...
      <p>
        Ever since that moment, Cedric and Yichen vowed to create musbe 2.0. The
        next was to expand musbe to other different schools, and hence
