...
import '../Home/CardFlexIcons.scss';
...
class CardFlexIcons extends Component {
    ...
    render() {
        ...
        let iconfragment = <div className="icons">
            {this.props.edit &&
            <img height="50px" alt="edit this" className="clickable-icon" src={edit_icon}/>
            }
            {this.props.delete &&
            <img height="50px" alt="delete this" className="clickable-icon" src={delete_icon}/>
            }
            {this.props.message &&
            <img height="50px" alt="message the owner of this" className="clickable-icon" src={message_icon}/>
            }
        </div>;
